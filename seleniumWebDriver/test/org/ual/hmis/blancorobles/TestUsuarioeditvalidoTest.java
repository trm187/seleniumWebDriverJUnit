...
public class TestUsuarioeditvalidoTest {
  ...
  public void usuarioEmailEdit() {
    ...
    vars.put("emailrandomNew", js.executeScript("return \"ual-\" + Math.floor(Math.random()*1500000)+\"@ual.es\""));
    driver.findElement(By.id("Input_NewEmail")).click();
    driver.findElement(By.id("Input_NewEmail")).sendKeys(vars.get("emailrandomNew").toString());
